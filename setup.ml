...
(* OASIS_START *)
(* DO NOT EDIT (digest: ae5b922dae19ad6075bcc582efd11359) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://oasis.ocamlcore.org/view/ocaml-xdg-basedir";
          synopsis =
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for XDGBaseDir";
                      doc_authors = [];
                      doc_abstract = None;
     ...
     oasis_digest = Some "<\001<\144\151\025A\151\193\221<\204w\251\189\141";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = true;
     };;
